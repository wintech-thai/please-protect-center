    ...
    const fetchOrganizations = async () => {
      try {
        ...
        if (storedOrgId && mappedOrgs.length > 0) {
          const foundOrg = mappedOrgs.find(
            (o: OrgItem) => o.id === storedOrgId,
          );
            ...
            {navItems.map((item) => (
              ...
              >
                ...
                >
                  {item.label}{" "}
                  <ChevronDown
                    className={`w-4 h-4 mt-0.5 opacity-70 transition-transform ${activeDropdown === item.label ? "rotate-180" : ""}`}
                  />
                </button>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative hidden lg:block" ref={orgDropdownRef}>
              ...
              >
                ...
                <ChevronDown
                  className={`w-3.5 h-3.5 text-slate-400 transition-transform ${isOrgOpen ? "rotate-180" : ""}`}
                />
              </button>
              {isOrgOpen && (
            ...
            <div className="relative hidden sm:block" ref={langDropdownRef}>
              ...
              >
                ...
                <span>{language}</span>
                <ChevronDown
                  className={`w-3 h-3 opacity-50 transition-transform ${isLangDropdownOpen ? "rotate-180" : ""}`}
                />
              </button>
              {isLangDropdownOpen && (
                  ...
                  <TooltipTrigger asChild>
                    ...
                    >
                      <div className="w-9 h-9 rounded-full bg-gradient-to-br from-blue-900 to-slate-800 border border-blue-700/50 flex items-center justify-center shadow-[0_0_10px_rgba(59,130,246,0.15)] group-hover:border-cyan-500/50 transition-all duration-300">
                        <User className="w-5 h-5 text-blue-200 group-hover:text-cyan-400" />
                      </div>
                    </button>
                  </TooltipTrigger>
                  <TooltipContent
                    side="bottom"
                    sideOffset={10}
                    className="bg-slate-800 border-blue-900/50 text-white shadow-xl px-3 py-1.5"
                  >
              ...
              {isProfileDropdownOpen && (
                <div className="absolute right-0 top-full mt-2 w-[200px] p-1 bg-[#0B1120] border border-blue-900/30 shadow-2xl rounded-lg text-blue-100 animate-in fade-in slide-in-from-top-2">
                  <button
                    ...
                    className="w-full flex items-center gap-2 px-3 py-2.5 text-sm rounded-md text-slate-300 hover:bg-blue-900/40 hover:text-cyan-400"
                  >
                  ...
                  <button
                    ...
                    className="w-full flex items-center gap-2 px-3 py-2.5 text-sm rounded-md text-red-400 hover:bg-red-900/20 border-t border-blue-900/30 mt-1"
                  >
          ...
          <div className="md:hidden absolute top-16 left-0 w-full bg-[#0B1120] border-b border-blue-900/30 shadow-lg max-h-[80vh] overflow-y-auto z-40 animate-in slide-in-from-top-2 text-blue-100">
            ...
            <div className="border-b border-blue-900/30">
              <button
                ...
                className="flex w-full items-center gap-3 px-4 py-4 text-base text-slate-400 hover:text-cyan-400"
              >
              ...
              <button
                onClick={handleLogout}
                className="flex w-full items-center gap-3 px-4 py-4 text-base text-red-400"
              >
